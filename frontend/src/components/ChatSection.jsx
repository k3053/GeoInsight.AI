...
const ChatSection = ({selectedCoords, onLocationFound}) => {
  const [query, setQuery] = useState("");
  ...
  const handleFormSubmit = (e) => {
    ...
    // Navigate to chatbot page and pass query
  ...
  return (
    <div className="flex flex-col h-full bg-black/60 text-[14px] backdrop-blur-md border-t border-gray-700 justify-end">
      <div className="p-3 border-t border-gray-700">
        <div className="mb-2 flex flex-wrap gap-2">
          {exampleQueries.map((ex, idx) => (
            <button
